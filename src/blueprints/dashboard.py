...
@dashboard_bp.route('/dashboard/activities', methods=['GET', 'POST'])
def m_activities():
    ...
    return render_template('dashboard/M-activities.html', activities=activities, activity_details=activity_details,
