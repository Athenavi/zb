...
INSERT INTO vip_plans (id, name, description, price, duration_days, level, features, is_active, created_at, updated_at)
VALUES (2, '进阶版', '最受欢迎的选择，性价比最高', 19.90, 30, 2,
...
INSERT INTO vip_plans (id, name, description, price, duration_days, level, features, is_active, created_at, updated_at)
VALUES (3, '尊享版', '极致体验，尊享所有特权', 29.90, 30, 3,
...
INSERT INTO vip_plans (id, name, description, price, duration_days, level, features, is_active, created_at, updated_at)
VALUES (1, '基础版', '适合初尝VIP体验的用户', 7.90, 31, 1, '{"ad_free": true, "premium_content": true}', true,
        '2025-09-27 16:15:43.039751', '2025-10-09 15:08:39.137751');
INSERT INTO vip_plans (id, name, description, price, duration_days, level, features, is_active, created_at, updated_at)
VALUES (4, '年度基础版', '年度订阅，更优惠', 89.00, 365, 1, '{"ad_free": true, "premium_content": true}', true,
        '2025-09-27 16:15:43.039758', '2025-10-09 15:09:43.400970');
INSERT INTO vip_plans (id, name, description, price, duration_days, level, features, is_active, created_at, updated_at)
VALUES (6, '年度尊享版', '年度订阅，尊享体验', 288.88, 372, 3,
